  ...
  return (
    <div className={styles.hero_sec}>
      <p className={styles.intro}>
        The energy storage market is growing at a fast pace to enable the global
        goal in energy and mobility transition. In electric mobility, OEMs have
        a daunting task to address the fast-emerging market demand for
